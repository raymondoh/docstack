...
export function LoginButton() {
  ...
  return (
    <button
      type="button" // <-- CRITICAL: Prevents silent form-submission reloads
      onClick={handleLogin}
      disabled={isLoading}
      className="flex w-full items-center justify-center gap-3 rounded-md bg-foreground px-4 py-2.5 text-sm font-medium text-background transition-colors hover:bg-foreground/90 disabled:opacity-70">
      {isLoading ? (
